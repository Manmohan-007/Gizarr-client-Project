...
class LatestTranaction extends Component {
    ...
    togglemodal = () => {
        ...
        // this.props.history.push("/contacts-profile")
                                ...
                                <tbody>
                                    {
                                        this.state.transactions.map((transaction, key) =>
                                            <tr key={"_tr_" + key}>
                                                ...
                                                <td>
                                                    <Link to="/contacts-profile"><Button type="button" color="primary" size="sm" className="btn-rounded waves-effect waves-light" onClick={this.togglemodal}>
                                                        View Details
                                                    </Button></Link>
                                                </td>
                                            </tr>
