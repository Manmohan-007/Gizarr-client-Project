...
import logo from "../../LogoImages/LogoMedium.png";
import logoLightPng from "../../LogoImages/LogoXL.png";
import logoLightSvg from "../../LogoImages/LogoXL.png";
import logoDark from "../../LogoImages/LogoXL.png";
              ...
              <div className="navbar-brand-box">
                <Link to="/" className="logo logo-dark">
                  ...
                  <span className="logo-lg">
                    <img src={logoDark} className="LogoTweek" alt="" height="17" />
                  </span>
                </Link>

                <Link to="/" className="logo logo-light">
                  <span className="logo-sm">
                    <img src={logoLightSvg} className="LogoTweek" alt="" height="22" />
                  </span>
                  <span className="logo-lg " >
                    <img src={logoLightPng} className="LogoTweek" alt="" />
                  </span>
                </Link>
              </div>
